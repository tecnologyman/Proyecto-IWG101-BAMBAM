...
function Home() {
  return (
    <div class="inicio">
      ...
      <h4>En la seccion tiendas puedes observar todas las tiendas que tendremos en la pagina, pero por ahora por la facilidad y confiabilidad solo estaran los comentarios sobre la pagina pcexpress, todo esto en la seccion "tiendas"</h4>
      <div class="pc">
        <h2>Esta Tienda es PcExpress</h2>
        <img src={intro} width="1100" height="850" class="pce"></img>
      </div>
    </div>
  );
}
